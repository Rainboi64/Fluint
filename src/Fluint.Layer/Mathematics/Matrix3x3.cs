...
public struct Matrix3x3 : IEquatable<Matrix3x3>, IFormattable
{
    ...
    public static void Orthogonalize(ref Matrix3x3 value, out Matrix3x3 result)
    {
        ...
        result.Row2 = result.Row2 -
                      Vector3.Dot(result.Row1, result.Row2) / Vector3.Dot(result.Row1, result.Row1) * result.Row1;

        result.Row3 = result.Row3 -
                      Vector3.Dot(result.Row1, result.Row3) / Vector3.Dot(result.Row1, result.Row1) * result.Row1;
        result.Row3 = result.Row3 -
                      Vector3.Dot(result.Row2, result.Row3) / Vector3.Dot(result.Row2, result.Row2) * result.Row2;
    }
    ...
    public static void BillboardLH(ref Vector3 objectPosition, ref Vector3 cameraPosition, ref Vector3 cameraUpVector,
        ref Vector3 cameraForwardVector, out Matrix3x3 result)
    {
