...
public static class RandomUtil
{
    ...
    {
        return new Vector3(random.NextFloat(min.X, max.X), random.NextFloat(min.Y, max.Y),
    ...
    {
        return new Vector4(random.NextFloat(min.X, max.X), random.NextFloat(min.Y, max.Y),
    ...
    {
        return new Color(random.NextFloat(0.0f, 1.0f), random.NextFloat(0.0f, 1.0f), random.NextFloat(0.0f, 1.0f),
            1.0f);
    }
    ...
    {
        return new Color(random.NextFloat(minBrightness, maxBrightness), random.NextFloat(minBrightness, maxBrightness),
            random.NextFloat(minBrightness, maxBrightness), 1.0f);
    }
    ...
    {
        return new Color(random.NextFloat(minBrightness, maxBrightness), random.NextFloat(minBrightness, maxBrightness),
            random.NextFloat(minBrightness, maxBrightness), alpha);
    }
    ...
    /// <returns>Random <see cref="DXPlayground.Mathematics.Color" />.</returns>
    public static Color NextColor(this Random random, float minBrightness, float maxBrightness, float minAlpha,
        float maxAlpha)
    {
        return new Color(random.NextFloat(minBrightness, maxBrightness), random.NextFloat(minBrightness, maxBrightness),
            random.NextFloat(minBrightness, maxBrightness), random.NextFloat(minAlpha, maxAlpha));
    }
