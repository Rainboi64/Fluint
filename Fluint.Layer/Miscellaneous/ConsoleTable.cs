...
{
    /// <summary>
    /// Shameless steal from https://github.com/khalidabuhakmeh/ConsoleTables/blob/master/src/ConsoleTables/ConsoleTable.cs
    /// </summary>
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Miscellaneous.Format.Default)
        {
            switch (format)
            {
                case Miscellaneous.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case Miscellaneous.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case Miscellaneous.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case Miscellaneous.Format.Minimal:
